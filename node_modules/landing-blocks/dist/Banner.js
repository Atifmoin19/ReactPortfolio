...
function Banner(_a) {
    ...
    var _k = support_1.getPageContainerProps(props), spacing = _k[0], rest = _k[1];
    var direction = flip ? 'row-reverse' : 'row';
    return (react_2.default.createElement(layout_1.PageContainer, __assign({}, spacing),
        react_2.default.createElement(react_1.Stack, __assign({ align: 'center', spacing: '40px', bg: 'gray.100', 
            // isReversed={flip}
