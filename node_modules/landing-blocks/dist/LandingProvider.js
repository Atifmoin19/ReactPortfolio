...
function LandingProvider(_a) {
    ...
    var theme = react_4.useMemo(function () {
    ...
    return (react_4.default.createElement(layout_1.PropagatedThemeProvider, { theme: theme },
        ...
        react_4.default.createElement(Mode, null,
            ...
            , __assign({ 
                // overflowX='hidden'
                width: '100%', height: '100%', overflowX: 'hidden', fontFamily: fontFamily, spacing: spacing, align: 'stretch', color: dark ? 'white' : 'black', borderColor: dark ? 'rgba(255,255,255,.3)' : 'gray.300' }, rest), children))));
}
exports.LandingProvider = LandingProvider;
var globalStyles = react_2.css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    * {\n        box-sizing: border-box;\n    }\n    html {\n        height: 100%;\n        width: 100%;\n        scroll-behavior: smooth;\n    }\n    #__next {\n        min-height: 100%;\n        /* height: 100%; */\n    }\n    body {\n        height: 100%;\n        width: 100%;\n        overflow: auto;\n        overflow-x: hidden;\n    }\n"], ["\n    * {\n        box-sizing: border-box;\n    }\n    html {\n        height: 100%;\n        width: 100%;\n        scroll-behavior: smooth;\n    }\n    #__next {\n        min-height: 100%;\n        /* height: 100%; */\n    }\n    body {\n        height: 100%;\n        width: 100%;\n        overflow: auto;\n        overflow-x: hidden;\n    }\n"])));
