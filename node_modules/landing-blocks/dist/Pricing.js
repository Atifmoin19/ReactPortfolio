...
function Pricing(_a) {
    ...
    var colorMode = hooks_1.useMyColorMode(rest).colorMode;
...
function PriceColumn(_a) {
    ...
    var realBg = support_1.useColor(priceSection.background || (dark ? '#000' : '#fff'));
    var lightness = color_js_1.default(realBg).getLightness();
