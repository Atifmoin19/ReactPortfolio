...
exports.Divider = function (_a) {
    var _b = _a.heading, heading = _b === void 0 ? '' : _b, rest = __rest(_a, ["heading"]);
    return (react_3.default.createElement(layout_1.PageContainer, __assign({}, rest), heading ? (react_3.default.createElement(react_2.Stack, { justify: 'center', align: 'center', spacing: '20px', direction: 'row', opacity: 0.6 },
...
function Line(porps) {
    ...
    return (react_3.default.createElement(react_2.Box, __assign({ bg: {
            light: color_js_1.default('black').setAlpha(0.3).toCSS(),
            dark: color_js_1.default('white').setAlpha(0.3).toCSS(),
