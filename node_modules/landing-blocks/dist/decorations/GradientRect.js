...
function lighter(c) {
    ...
    var newColor = color_js_1.default(c).setAlpha(0.06);
...
exports.GradientRect = function (_a) {
    ...
    return (react_2.default.createElement(react_1.Box, __assign({ w: '80%', height: '70%', background: "linear-gradient(45deg, " + primary + " 30%, " + secondary + " 60%)", style: {
            clipPath: clipPath,
        } }, rest)));
};
