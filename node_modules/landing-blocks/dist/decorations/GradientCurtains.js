...
function lighter(c, amount) {
    ...
    c = support_1.useColor(c);
    var newColor = color_js_1.default(c).setAlpha(amount);
    return newColor.toCSS();
}
exports.GradientCurtains = function (_a) {
    ...
    var linesColor = "linear-gradient(217deg," + lighter(primary) + " 30%," + lighter(primary, 1) + ")";
    primary = lighter(primary);
    secondary = lighter(secondary);
    return (react_2.default.createElement(react_1.Box, __assign({ w: '100%', minHeight: '120%', backgroundImage: "radial-gradient(circle at 70% 70%," + primary + "," + secondary + ")", transform: 'skewY(-14.5deg)', position: 'relative' }, rest),
