...
function PatternBackground(_a) {
    ...
    return (react_2.default.createElement(react_1.Box, __assign({ transform: "translate(" + scatter + "px, " + scatter + "px)" }, patterns[pattern], props),
        react_2.default.createElement(react_1.Box, { transform: "translate(" + -scatter + "px, " + -scatter + "px)" }, children)));
}
