...
function HowItWorks(_a) {
    ...
    var Faded = hooks_1.useFaded({ animate: animate }).Faded;
    return (react_2.default.createElement(layout_1.PageContainer, __assign({ spacing: '40px', py: '120px' }, rest),
...
var Step = function (_a) {
    ...
    return (react_2.default.createElement(react_1.Stack, __assign({ justify: 'space-between', align: 'center', direction: ['column', null, flip ? 'row-reverse' : 'row'], spacing: '40px' }, rest),
        react_2.default.createElement(react_1.Stack, { as: Faded, minW: '300px', maxW: '500px', flex: '1', spacing: '40px' },
            react_2.default.createElement(react_1.Stack, { direction: 'row', align: 'flex-end', opacity: 0.3 },
                react_2.default.createElement(react_1.Box, { opacity: 0.5, lineHeight: '60px', fontSize: '80px' }, number),
