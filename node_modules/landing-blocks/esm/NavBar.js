...
export var NavBar = function (_a) {
    var logo = _a.logo, _b = _a.navs, navs = _b === void 0 ? [] : _b, rest = __rest(_a, ["logo", "navs"]);
    ...
    return (React.createElement(PageContainer, __assign({ py: '20px' }, rest),
        React.createElement(Row, null,
            ...
            React.createElement(Stack, { maxW: '100%', direction: 'row', spacing: '20px', align: 'center', display: ['none', 'none', 'flex'] }, Array.isArray(navs) ? (React.createElement(Stack, { align: 'center', direction: 'row', spacing: '20px' }, navs.map(function (x, i) { return (React.createElement(Stack, { key: i, fontSize: 'text', alignItems: 'center', justify: 'center', fontWeight: 'medium' }, x)); }))) : (navs)),
            React.createElement(Button, { display: ['block', 'block', 'none'], variant: 'link', onClick: onOpen },
                React.createElement(Box, { stroke: { light: 'black', dark: 'white' }[colorMode], as: Menu, size: '36px' }))),
